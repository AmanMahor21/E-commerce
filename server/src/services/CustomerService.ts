...
import { Brackets, getConnection, Like, Repository } from 'typeorm/index';
import { Customer } from '../models/Customer';
import { AppDataSource } from '../database/connection';

@Service()
export class CustomerService {
  // constructor(@InjectRepository(Customer) private customerRepository: Repository<Customer>) {} // ✅ Inject repository
