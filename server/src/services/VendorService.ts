...
import { Brackets, Like, Repository, getConnection } from 'typeorm/index';
...
export class VendorService {
  ...
  // find Selected
  public findSelected(data: any): Promise<any> {
    return this.vendorRepository.find({
      where: data,
      select: ['customerId', 'companyName', 'companyLogo', 'companyLogoPath', 'vendorDescription'],
    });
  }
  ...
  //   count: number | boolean
  // ): Promise<any> {
  //   return await this.vendorRepository.vendorList(
  //     limit,
  //     offset,
  //     select,
  //     relations,
  ...
  // public async validateDisplayUrlName(
  //   data: string,
  //   checkVendor: number,
  //   vendorId: number
  // ): Promise<any> {
