...
export class Vendor extends BaseModel {
  ...
  @OneToMany(
    (type) => VendorOrderArchiveLog,
    (vendorOrderArchiveLog) => vendorOrderArchiveLog.vendor
  )
  ...
  @OneToMany(
    (type) => VendorProductFavorites,
    (vendorProductFavorites) => vendorProductFavorites.vendor
  )
  public vendorProductFavorites: VendorProductFavorites[];
